            ...
            <table class="w-full text-sm">
                ...
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-4 py-3 text-center ">Melhor sequência</th>
                        <th class="px-4 py-3 text-center ">Melhor seq. sem zerar</th>
                ...
                <tbody class="divide-y divide-(--color-border)]">
                    ...
                    ">
                            ...
                            <td class="px-4 py-3 font-semibold flex">
                                {{ $medal }} <x-ui.icon name="chevron-double-up" class="text-green-500 size-3 font-bold" />
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <div class="w-16 h-2 rounded-full bg-(--color-border) overflow-hidden">
                                        <div class="h-full bg-(--color-accent)]"
                                            style="width: {{ (int) $user->accuracy }}%">
                                        </div>
                                    </div>
